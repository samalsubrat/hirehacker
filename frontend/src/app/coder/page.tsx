          ...
          <div className="border rounded-lg h-full w-10 mr-0.5 flex flex-col">
            ...
            <ul className="flex flex-col gap-2 items-center py-2">
              {QUESTIONS.map((question, idx) => {
                // Check if this is an MCQ question and if it has been answered
                            ...
                            setCodes((codes) => {
                              ...
                              newCodes[currentQuestion] =
                                QUESTIONS[currentQuestion].code?.[
                                  val as keyof (typeof QUESTIONS)[0]["code"]
                                ] || "";
                              return newCodes;
                            });
                          }}
              ...
              <div className="p-4">
                ...
                <form>
                  ...
                  <Button
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      // Handle subjective answer submission logic here
                      console.log(
